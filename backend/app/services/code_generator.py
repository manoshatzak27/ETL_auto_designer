...
def _generate_location_script(project) -> str:
    ...
    return (
        ...
        "import pandas as pd\n"
        "\n"
        "# Auto-generated OMOP location ETL script — do not edit manually.\n"
        "\n"
        ...
        "\n"
        "        # Person address\n"
        + _xtr_v("address_1", a1_col) + "\n"
        + _xtr_v("address_2", a2_col) + "\n"
        + _xtr_v("city", city_col) + "\n"
        + _xtr_v("state", state_col) + "\n"
        + _xtr_v("zip_code", zip_col) + "\n"
        + _xtr_v("county", county_col) + "\n"
        + _xtr_v("latitude", lat_col) + "\n"
        + _xtr_v("longitude", lon_col) + "\n"
        + (
        ...
        + "\n"
        + "        # Care site address\n"
        + _xtr_v("cs_address_1", cs_a1_col) + "\n"
        + _xtr_v("cs_address_2", cs_a2_col) + "\n"
        + _xtr_v("cs_city", cs_city_col) + "\n"
        + _xtr_v("cs_state", cs_state_col) + "\n"
        + _xtr_v("cs_zip_code", cs_zip_col) + "\n"
        + _xtr_v("cs_county", cs_county_col) + "\n"
        + (
