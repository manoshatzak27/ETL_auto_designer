...
def _generate_stem_table_script(project) -> str:
    ...
    inner_rows = (
        ...
        "                                except ValueError:\n"
        "                                    print(f'WARNING: row {_src_idx} — variable {variable!r} — start datetime {_raw_start_dt!r} does not match format {_dt_fmt!r}; keeping visit-derived date')\n"
        "                            else:\n"
        "                                print(f'WARNING: row {_src_idx} — variable {variable!r} — start datetime column {_start_dt_col!r} is empty; keeping visit-derived date')\n"
