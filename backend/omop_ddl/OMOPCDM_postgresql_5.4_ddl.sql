...
--Vendored from OHDSI/CommonDataModel v5.4 — https://github.com/OHDSI/CommonDataModel/tree/v5.4/inst/ddl/5.4/postgresql
--The omop-init service substitutes @cdmDatabaseSchema with the schema set in $OMOP_SCHEMA before piping into psql.
